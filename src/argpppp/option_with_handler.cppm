...
{
public:
    option_with_handler(const option& o, int key, std::unique_ptr<option_handler> h)
        : m_option(o)
        , m_key(key)
...
ARGPPPP_EXPORT_FOR_UNIT_TESTING
argp_option to_argp_option(const option& o); // TODO: this should not be here, it should be a part of option's interface
