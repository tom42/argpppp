...
class value_option_handler final : public option_handler
{
public:
    value_option_handler(TValue& v) : m_v(v) {}
private:
    TValue& m_v;
...
template <typename TValue>
std::shared_ptr<value_option_handler<TValue>> value(TValue& v)
{
    return std::make_shared<value_option_handler<TValue>>(v);
}
